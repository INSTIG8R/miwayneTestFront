...
class NewQuoteSHTests(unittest.TestCase):
    ...
    def test_lines(self):
        ...
        enabled = self.qf.enterConsignmentLine_1(services1='SUPERECONOMY', item1='ITEM', commodity1='GENERAL ITEM', quantity1='2', weight1='100', volume1='0.448')
        time.sleep(3)
    ...
    #     if _res:
    #         self.ts.markFinal("Additional Information Section Test", True, "Additional Information Fields are Working Correctly!!!")
    #     else:
    #         self.ts.markFinal("Additional Information  Section Test", False, "### Additional Information Fields are not Working Correctly!!!")
    #     time.sleep(2)
    #
    #
    # @pytest.mark.order(6)
